...
public class TestQuerySessionSupplier
{
    ...
    public void testCreateSession()
    {
        ...
        Session session = sessionSupplier.createSession(new QueryId("test_query_id"), Optional.empty(), context, warningCollectorFactory, Optional.empty());
    ...
    public void testInvalidTimeZone()
    {
        ...
        sessionSupplier.createSession(new QueryId("test_query_id"), Optional.empty(), context, warningCollectorFactory, Optional.empty());
    }
}
