...
public class TestJoinNodeFlattener
{
    ...
    public void testProjectNodesBetweenJoinNodesAreFlattenedForComplexEquiJoins()
    {
        ...
        ProjectNode projectOverJoin1 = p.project(assignmentA1PlusB1, p.join(
                INNER,
                valuesA,
                valuesB,
                ImmutableList.of(equiJoinClause(a1, b1)),
        ...
        ProjectNode projectOverJoin2 = p.project(assignmentRenameC1, p.join(
                INNER,
                valuesC,
                valuesD,
        ...
        MultiJoinNode expected = MultiJoinNode.builder()
                .setSources(valuesA, valuesB, valuesC, valuesD)
                .setFilter(and(and(createEqualsExpression(a1, b1), createEqualsExpression(c1, d1)), createEqualsExpression(createAddExpression(a1, b1), c1)))
                .setAssignments(Assignments.of(sum, createAddExpression(a1, b1), rename, c1))
                .setOutputVariables(a1,b1,c1)
                .build();
        MultiJoinNode actual = toMultiJoinNode(joinNode, noLookup(), 5, /*handleComplexEquiJoins*/ true, functionResolution, determinismEvaluator);
        ...
        expected = MultiJoinNode.builder()
                .setSources(projectOverJoin1, projectOverJoin2)
                .setFilter(createEqualsExpression(sum, rename))
                .setAssignments(Assignments.of())
                .setOutputVariables(sum,rename)
                .build();
