        ...
        extends BasePlanTest
{
    ...
    @DataProvider
    public static Object[][] equiJoinTestCases()
    {
        return new Object[][] {
                {"a = b", new String[] {"a", "b"}},
                {"a = b and c = d", new String[] {"a", "b", "c", "d"}},
                {"a > b and c = d", new String[] {"c", "d"}},
                {"a + b > 10", new String[] {}},
                {"a != 10 - b", new String[] {}}
        };
    }
    ...
    @Test(dataProvider = "equiJoinTestCases")
    public void testNotNullInferenceForEquiJoinOnlyStrategy(String filterSql, String[] expectedInferredNotNullVariables)
    {
        assertInferredNotNullVariableRefsListMatch(EQUI_JOIN_ONLY, filterSql, buildVariableReferencesList(expectedInferredNotNullVariables));
    }
