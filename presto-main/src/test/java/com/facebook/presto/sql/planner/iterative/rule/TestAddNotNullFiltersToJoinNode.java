        ...
        extends BasePlanTest
{
    ...
    public void testExtractInferredNotNullVariablesVisitorForStandardOperators(String filterSql, String[] expectedInferredNotNullVariables)
    {
        ...
        assertInferredNotNullVariableRefsListMatch(session, filterSql, buildVariableReferencesList(expectedInferredNotNullVariables));
    }

    @Test(dataProvider = "nonStandardOperatorTestCases")
    public void testExtractInferredNotNullVariablesVisitorForNonStandardOperators(String filterSql, String[] expectedInferredNotNullVariables)
    {
        Session session = testSessionBuilder()
                .setCatalog("local")
                .setSchema("tiny")
    ...
    {
        Set<VariableReferenceExpression> actual = new AddNotNullFiltersToJoinNode(functionAndTypeManager).getExistingNotNullVars(
    ...
    private void assertInferredNotNullVariableRefsListMatch(Session session,
