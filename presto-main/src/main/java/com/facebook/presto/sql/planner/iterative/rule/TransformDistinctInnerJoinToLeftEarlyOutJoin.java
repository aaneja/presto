        ...
        implements Rule<AggregationNode>
{
    ...
    private boolean canAggregationBePushedDown(AggregationNode aggregationNode, JoinNode joinNode, Context context)
    {
        ...
        LogicalProperties aggNodelogicalProperties = context.getLogicalPropertiesProvider().get().getAggregationProperties(aggregationNode);
        if (!aggNodelogicalProperties.canBeHomogenized(joinInputVariablesRight, groupingVariables)) {
            return false;
        }
